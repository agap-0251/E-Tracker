...
const RecentBlock = ({arr}) => {
  ...
  return (
    <div className='p-0 overflow-y-auto scroll max-h-[29rem] shadow-inner shadow-black ml-1
      xl:max-h-[23rem] 
      ...
      '>
      <h1 className='text-3xl text-cgreen-light my-3
      xl:mb-6'>Recent History</h1>
      {
