...
const NavContainer = () => {
  ...
  return (
    <div className="bg-cblack-light shadow-inner shadow-black border-gray-300 text-white h-full 
      ...
      className="m-4 py-3 px-5 bg-cyan-600 text-xl hover:bg-cyan-500 shadow-inner shadow-cyan-100 border-none outline-none rounded-full"
       type="button">
        SignOut
      </button>
    </div>
