...
const MenuIcon = ({showNav,setShowNav}) => {
  return (
    <div className='lg:hidden flex items-center '>
      ...
      <svg
        className="w-10 h-10 absolute top-2 left-2 text-white ml-5 mt-5
          xs:w-7 xs:h-7
          xxs:w-6 xxs:h-6 "
        aria-hidden="true"
        fill="currentColor"
      ...
      <h2 className='text-[2.7rem] text-corange-light ml-16
        xs:text-[2rem] xs:ml-12
        xxs:text-[1.7rem] xxs:ml-10 xxs:mt-[0.1rem]'>E-Tracker</h2>
    </div>
  )
}
